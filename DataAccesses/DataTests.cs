...
namespace DataAccesses
{
    public class clsDataTests
    {
        ...
        public static int AddNewTest(int CreatedByUserID, string Notes, int TestAppointmentID, bool TestResult)
        {
            int TestID = -1;
        ...
        public static bool UpdateTest(int TestID, int CreatedByUserID, string Notes, int TestAppointmentID, bool TestResult)
        {
