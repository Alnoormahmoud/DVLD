...
namespace DataAccesses
{
    public  class clsDataInternationalLicenses
    {
        ...
        public static bool FindInternationalLicenseByLicenseId(int InternationalLicenseID, ref int ApplicationID, ref int DriverID, ref int IssuedUsingLocalLicenseID, ref DateTime IssueDate,
